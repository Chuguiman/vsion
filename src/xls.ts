...
export function writeXlsx(cands: Candidate[], meta: GazetteMeta, outPath: string): void {
  const rows = cands.map((c) => ({
    ...
    "Veredicto IA": REC_LABEL[c.ai?.recommendation ?? "no_action"],
  ...
  ws["!cols"] = [
    { wch: 10 }, { wch: 28 }, { wch: 16 }, { wch: 12 }, { wch: 14 }, { wch: 28 },
    { wch: 28 }, { wch: 14 }, { wch: 16 }, { wch: 14 }, { wch: 28 }, { wch: 7 },
    { wch: 14 }, { wch: 16 }, { wch: 12 }, { wch: 11 }, { wch: 50 }, { wch: 60 },
  ];
